...
import com.example.datebasetest.R;
import java.util.Date;
import com.example.datebasetest.dateBasemethod.*;
import com.example.datebasetest.dateBasemethod.dateBase;
/*
        ...
        insert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                  ...
                  clothesInformationPacg ci= new clothesInformationPacg(1,"夹克","red","厚","123456","婚礼","1");
                  ContentValues values=ci.getValues();
                    clothesInformationPacg cii= new clothesInformationPacg(2,"西装","red","厚","123456","职场","1");
            ...
            public void onClick(View v) {
                try {
                 ...
                 /*   ContentValues values=new ContentValues();
                    ...
                    values.put("userid","123");*/
                    clothesInformationPacg ci= new clothesInformationPacg(1,"夹克","red","厚","123456","宴会","1");
                    ContentValues values=ci.getValues();
                    db.update(values);
                    db.close();
                }catch (Exception e){
